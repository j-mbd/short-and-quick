 ...
 * jad and the app to have been "ams-install" via the VM proxy. The Push
 * Registry doesn't seem to work if installed via NetBeans (i.e. telneting into
 * the port works but the startApp() method doesn't seem to be invoked when data
 * is sent through).
 *
